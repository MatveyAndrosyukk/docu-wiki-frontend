...
const EnterEmailModal: FC = () => {
    ...
    const messageText = changeEmailHandler.state.message ||
    ...
    return (
        <Modal
            isOpen={
                changeEmailHandler.state.isModal
            }
        ...
        >
            ...
            >
                <div
                    ...
                    ${styles['enter-email-modal__form']}
                    `}
                >
                    <div
                        className={
                    ...
                    <div
                        className={
                            styles['enter-email-modal__body']
                        }
                    >
                        <input
                            ref={
                                changeEmailHandler.state.inputRef
                            }
                            ...
                            ${styles['enter-email-modal__input-input']}
                            `}

                            placeholder="Enter your registered email"

                            value={
                                changeEmailHandler.state.value
                            }

                            disabled={
                                changeEmailHandler.state.loading
                            }

                            onChange={
                                changeEmailHandler.actions.handleChangeEmail
                            }
                        />
                        <button
                            className={`
                            ${modalStyles['modal__button']} 
                            ${styles['enter-email-modal__button-button']}
                            `}

                            disabled={
                                changeEmailHandler.state.loading ||
                                !changeEmailHandler.state.value.trim()
                            }

                            onClick={
                                changeEmailHandler.actions.sendChangePasswordLink
                            }
                        >
                            {
                                changeEmailHandler.state.loading
