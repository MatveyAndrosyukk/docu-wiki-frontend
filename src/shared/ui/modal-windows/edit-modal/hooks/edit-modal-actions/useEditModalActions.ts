...
import {PremiumState} from "../../../premium-modal/utils/hooks/usePremiumModal";
...
} from "../../../../context-menu/hooks/useContextMenuFileActions";
...
export default function useEditModalActions(
    ...
    const {
    ...
    } = useSelector((state: RootState) => (
        {
            ...
            totalFiles: state.user.viewedUser?.amountOfFiles ?? 0,
        }
    ));
