...
import useRegisterActions, {RegisterState} from "./useRegisterActions";
import useLoginActions, {LoginState} from "./useLoginActions";
...
export default function useAuthActions(): AuthorizationState {
