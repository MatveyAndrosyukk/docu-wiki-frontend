...
const userSlice = createSlice({
        ...
        reducers: {
            ...
            updateUserFilesCount: (
                ...
                if (state.viewedUser.email
                    !== action.payload.email) return;

                state.viewedUser.amountOfFiles
        ...
        extraReducers: (
            ...
            builder
                .addCase(
                    fetchViewedUserByEmail.pending,
                    (
                        state
                    ) => {
                ...
                .addCase(
                    fetchViewedUserByEmail.fulfilled,
                    (
                        state,
                        action
                    ) => {
                ...
                .addCase(
                    fetchViewedUserByEmail.rejected,
                    (state
                    ) => {
                ...
                .addCase(
                    fetchLoggedInUserByEmail.fulfilled,
                    (
                        state,
                        action
                    ) => {
                ...
                .addCase(
                    fetchLoggedInUserByEmail.rejected,
                    (
                        state
                    ) => {
                ...
                .addCase(
                    deleteUserWhoCanEdit.fulfilled,
                    (
                        state,
                        action
                    ) => {
                ...
                .addCase(
                    toggleUserIsViewBlocked.pending,
                    (
                        state,
                        action
                    ) => {
                        ...
                        if (state.viewedUser.email
                            !== action.meta.arg) return;

                        state.viewedUser.isViewBlocked =
                            !state.viewedUser.isViewBlocked;
                    }
                )
                .addCase(
                    toggleUserIsViewBlocked.rejected,
                    (
                        state,
                        action
                    ) => {
