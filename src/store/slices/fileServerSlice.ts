...
const fileServerSlice = createSlice(
    {
        ...
        reducers: {
            ...
            revertFileContent(
                ...
                file.lastEditor =
                    action.payload.prevLastEditor ?? file.lastEditor;
            },
            ...
            builder
                ...
                .addCase(
                    ...
                    (
                        ...
                        const parentId =
                            typeof serverFile.parent === "number"
                                ? serverFile.parent
                                : null;
                        ...
                        const addToParent = (
                            ...
                            for (const node of nodes) {
                                ...
                                if (node.children &&
                                    addToParent(node.children)) return true;
                            }
